                    ...
                    <div className="pt-2 space-y-2">
                        <button onClick={() => {
                            ...
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 448 512">
                                <path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L32 508l146.2-38.3c32.5 17.7 68.9 27 106.3 27 122.4 0 222-99.6 222-222 0-59.3-23-115.1-65-157.1zM223.9 474c-33.1 0-65.7-8.9-94.1-25.7l-6.7-4-87.1 22.8 23.2-84.8-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 54 81.2 54 130.4 0 101.7-82.8 184.5-184.6 184.5zm100.5-137.5c-5.5-2.7-32.5-16.1-37.5-17.9-5-1.8-8.6-2.7-12.3 2.7-3.6 5.5-14.1 17.9-17.3 21.5-3.2 3.6-6.4 4.1-11.8 1.4-5.4-2.7-22.9-8.4-43.6-26.8-16.1-14.4-27-32.1-30.1-37.5-3.1-5.4-.3-8.3 2.4-11 2.5-2.4 5.5-6.4 8.2-9.5 2.7-3.1 3.6-5.4 5.4-9.1 1.8-3.6.9-6.8-.5-9.5-1.4-2.7-12.3-29.6-16.9-40.7-4.5-10.8-9-9.3-12.3-9.5-3.2-.2-6.8-.2-10.4-.2-3.6 0-9.5 1.3-14.5 6.8-5 5.5-19.1 18.6-19.1 45.4 0 26.8 19.5 52.7 22.2 56.3 2.7 3.6 38.5 58.8 93.2 82.5 13 5.6 23.2 9 31.1 11.5 13.1 4.2 25 3.6 34.5 2.2 10.6-1.6 32.5-13.3 37.1-26.2 4.6-12.8 4.6-23.8 3.2-26.2-1.4-2.4-5-3.8-10.5-6.5z"/>
                            </svg>
